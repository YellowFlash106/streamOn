...
const Navbar = () => {
  ...
  return (
    <>
    <nav className='bg-base-200 border-b border-b-sky-300 sticky top-0 z-30 h-16 flex items-center'>
      <div className='container m-auto px-4 sm:px-6 lg:px-8' >
      <div className='flex items-center justify-end w-full'>
        {/* Only if we are in chat page  */}
        { isChatPage && (
          <div className='pl-5'>
        ...
        <div className='avatar'>
          ...
          <img src={authUser?.profilePic} alt="User Avatar" rel="noneferrer" />
          </div>
        </div>
